...
namespace OpenBots.Server.Web.Controllers
{
    ...
    public class FilesController : EntityController<StorageFile>
    {
        ...
        /// <summary>
        /// Gets count of storage files in database
        /// </summary>
        /// <param name="driveName"></param>
        /// <param name="filter"></param>
        /// <response code="200">Ok, count of storage files</response>
        /// <response code="400">Bad request</response>
        /// <response code="403">Forbidden</response>
        /// <response code="404">Not found</response>
        /// <response code="422">Unprocessable entity</response>
        /// <returns>Count of all storage files</returns>
        [HttpGet("count")]
        [Produces("application/json")]
        ...
        /// <summary>
        /// Gets count of storage folders in database
        /// </summary>
        /// <param name="driveName"></param>
        /// <param name="filter"></param>
        /// <response code="200">Ok, count of storage folders</response>
        /// <response code="400">Bad request</response>
        /// <response code="403">Forbidden</response>
        /// <response code="404">Not found</response>
        /// <response code="422">Unprocessable entity</response>
        /// <returns>Count of all storage folders</returns>
        ...
        /// <summary>
        /// Provides storage drive details for local storage
        /// </summary>
        /// <param name="driveName"></param>
        /// <response code="200">Ok, if the storage drive exists</response>
        /// <response code="304">Not modified</response>
        /// <response code="400">Bad request, if storage drive entity is not in proper format</response>
        /// <response code="403">Forbidden</response>
        /// <response code="404">Not found, when no storage drive exists</response>
        /// <response code="422">Unprocessable entity</response>
...
//update storage drive details/rename?
